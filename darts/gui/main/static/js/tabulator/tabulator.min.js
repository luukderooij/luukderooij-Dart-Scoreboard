...
!(function (e, t) {
  ...
  class c extends e {
    ...
    initializeScrollWheelWatcher() {
      this.contentsElement.addEventListener("wheel", (e) => {
        var t;
        e.deltaX &&
          ((t = this.contentsElement.scrollLeft + e.deltaX),
    ...
    getColumnsByFieldRoot(e) {
      ...
      return (
        Object.keys(this.columnsByField).forEach((i) => {
          (this.table.options.nestedFieldSeparator
            ? i.split(this.table.options.nestedFieldSeparator)[0]
            : i) === e && t.push(this.columnsByField[i]);
        }),
        t
      );
    }
  ...
  class g extends l {
    ...
    _virtualRenderFill(e, t, i) {
      ...
      if (((i = i || 0), (e = e || 0))) {
        ...
        (c = (g - e + 1) * this.vDomRowHeight) < E &&
          (e -= Math.ceil((E - c) / this.vDomRowHeight)) < 0 &&
          (e = 0),
          (e -= l =
            Math.min(
              Math.max(
      ...
      if (g && r.elVisible(this.elementVertical)) {
        for (
          this.vDomTop = e,
            this.vDomBottom = e - 1,
            C || this.table.options.maxHeight
              ? (y && (w = E / y + this.vDomWindowBuffer / y),
                (w = Math.max(this.vDomWindowMinTotalRows, Math.ceil(w))))
              : (w = g);
          (w == g ||
            h <= E + this.vDomWindowBuffer ||
            v < this.vDomWindowMinTotalRows) &&
          this.vDomBottom < g - 1;

        ) {
          for (
            f = [], o = document.createDocumentFragment(), p = 0;
            p < w && this.vDomBottom < g - 1;

          )
            (s = m[(b = this.vDomBottom + 1)]),
              this.styleRow(s, b),
              s.initialize(!1, !0),
              s.heightInitialized ||
                this.table.options.rowHeight ||
          ...
          n.appendChild(o),
            ...
            R &&
              ...
              (w = Math.max(
                ...
                Math.ceil(E / y + this.vDomWindowBuffer / y)
              )));
        }
        e
          ? ((this.vDomTopPad = t
            ...
            (this.vDomBottomPad =
              this.vDomBottom == g - 1
                ? 0
                : Math.max(this.vDomScrollHeight - this.vDomTopPad - h - u, 0)))
          : ((this.vDomTopPad = 0),
            (this.vDomRowHeight = Math.floor((h + u) / v)),
            (this.vDomBottomPad =
              this.vDomRowHeight * (g - this.vDomBottom - 1)),
          ...
          t &&
            (this.scrollTop =
              ...
              this.elementVertical.clientWidth
                ? this.elementVertical.offsetHeight - E
                : 0)),
          (this.scrollTop = Math.min(
            this.scrollTop,
            this.elementVertical.scrollHeight - E
          )),
          this.elementVertical.scrollWidth > this.elementVertical.clientWidth &&
            t &&
            (this.scrollTop += this.elementVertical.offsetHeight - E),
  ...
  class b extends e {
    ...
    initializePlaceholder() {
      ...
      if (
        ("function" == typeof e && (e = e.call(this.table)),
    ...
    adjustTableSize() {
      ...
      if ("fill" === this.renderer.verticalFillMode) {
        ...
        if (this.fixedHeight) {
          ...
          (this.element.style.height = ""),
            (this.element.style.height =
              this.table.element.clientHeight - s + "px"),
  ...
  class S extends k {
    ...
    initializeColumn(e) {
      e.definition.widthGrow &&
        (e.definition.widthGrow = Number(e.definition.widthGrow)),
        e.definition.widthShrink &&
          (e.definition.widthShrink = Number(e.definition.widthShrink));
    }
    getMode() {
      return this.mode;
    }
  ...
  function _(e, t) {
    ...
    if (((t = t || ""), Array.isArray(e)))
      ...
      for (var s in e) i = i.concat(_(e[s], t ? t + "[" + s + "]" : s));
  ...
  var K = {
    ...
    xlsx: function (t, i, s) {
      ...
      if (
        ((l.type = "binary"), (n.SheetNames = []), (n.Sheets = {}), i.sheetOnly)
      )
        s(h());
      else {
        if (i.sheets)
  ...
  class $ {
    ...
    _keyTab(e) {
      this.params.autocomplete && "typing" === this.lastAction
        ...
        : this.focusedItem && this._chooseItem(this.focusedItem, !0);
    }
    _keyUp(e) {
    ...
    focusScrollAdjust(e) {
      if ("virtual" == this.table.rowManager.getRenderMode()) {
        ...
        var o = this.table.rowManager.element.scrollLeft,
          ...
          r = e.getElement();
        this.table.modExists("frozenColumns") &&
          ((o += parseInt(this.table.modules.frozenColumns.leftMargin || 0)),
  ...
  var ne = {
    ...
    money: function (e, t, i) {
      ...
      if (
        (l < 0 && ((l = Math.abs(l)), (h = u)),
        (s = !1 !== g ? l.toFixed(g) : l),
        (o = (s = String(s).split("."))[0]),
        (n = s.length > 1 ? d + s[1] : ""),
        !1 !== t.thousand)
      )
        for (r = /(\d+)(\d{3})/; r.test(o); ) o = o.replace(r, "$1" + c + "$2");
      return (
        (a = o + n),
        !0 === h
          ? ((a = "(" + a + ")"), m ? a + p : p + a)
  ...
  (ue.moduleName = "history"),
    (ue.undoers = {
      ...
      rowMove: function (e) {
        ...
        this.table.rowManager.moveRowActual(
          e.component,
          this.table.rowManager.getRowFromPosition(e.data.posFrom),
          t
        ),
    ...
    (ue.redoers = {
      ...
      rowMove: function (e) {
        this.table.rowManager.moveRowActual(
          e.component,
          this.table.rowManager.getRowFromPosition(e.data.posTo),
          e.data.after
        ),
          this.table.rowManager.regenerateRowPositions(),
          this.table.rowManager.reRenderInPosition();
    ...
    _extractHeaders(e, t) {
      for (var i = 0; i < e.length; i++) {
        ...
        r ? (n = !0) : (r = { title: o.textContent.trim() }),
          r.field ||
            (r.field = o.textContent.trim().toLowerCase().replaceAll(" ", "_")),
  ...
  class Re extends k {
    ...
    userSetPageToRow(e) {
      return this.table.options.pagination &&
        (e = this.table.rowManager.findRow(e))
        ? this.setPageToRow(e)
        : Promise.reject();
    }
    userSetPageSize(e) {
  ...
  class ke extends k {
    ...
    tableBuilt() {
      ...
      this.config.sort &&
        ...
        this.config.headerFilter &&
          !1 == !(i = this.load("headerFilter")) &&
          (this.table.options.initialHeaderFilter = i);
    }
    tableRedraw(e) {
    ...
    setColumnLayout(e) {
      return (
        this.table.columnManager.setColumns(
          this.mergeDefinition(this.table.options.columns, e, !0)
        ),
        !0
      );
    }
      ...
      return (
        (t = t || []).forEach((t, o) => {
          ...
          r &&
            ...
            r.columns &&
              (r.columns = this.mergeDefinition(r.columns, t.columns)),
            s.push(r));
        }),
        e.forEach((e, i) => {
          this._findColumn(t, e) ||
            (s.length > i ? s.splice(i, 0, e) : s.push(e));
        }),
        s
      );
    }
      ...
      switch (typeof e) {
        ...
        case "string":
          (t = this.table.rowManager.findRow(e)) ||
            (t = this.table.rowManager.getRows(e));
          break;
        default:
          t = e;
      }
      ...
      switch (typeof e) {
        ...
        case "string":
          (i = this.table.rowManager.findRow(e)) ||
            (i = this.table.rowManager.getRows(e));
          break;
        default:
          i = e;
      }
    ...
    _deselectRow(e, t) {
      ...
      if (n) {
        if (
          ...
          return (
            (s = n.getElement()) && s.classList.remove("tabulator-selected"),
  ...
  class _e extends k {
    ...
    initializeColumn(e) {
      ...
      switch (typeof e.definition.sorter) {
        case "string":
          _e.sorters[e.definition.sorter]
            ? (s = _e.sorters[e.definition.sorter])
            : console.warn(
