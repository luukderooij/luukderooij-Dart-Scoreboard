...
class dartDB:
    ...
    def create_tables(self):
        queries = [
            ...
            "CREATE TABLE IF NOT EXISTS TournamentTeams (Id INTEGER PRIMARY KEY AUTOINCREMENT, TournamentId INTEGER NOT NULL, TeamName TEXT, Player1_Id INTEGER NOT NULL, Player2_Id INTEGER NOT NULL, FOREIGN KEY(TournamentId) REFERENCES Tournament(Id) ON DELETE CASCADE)",
            ...
            "CREATE TABLE IF NOT EXISTS RoundRobinStandings (Id INTEGER PRIMARY KEY AUTOINCREMENT, TournamentId INTEGER NOT NULL, Pool INTEGER, Place INTEGER, PlayerId TEXT NOT NULL, MatchesPlayed INTEGER, MatchesWon INTEGER, MatchesLost INTEGER, LegsScored INTEGER, LegsAgainst INTEGER, LegsDifference INTEGER, FOREIGN KEY(TournamentId) REFERENCES Tournament(Id) ON DELETE CASCADE)",
